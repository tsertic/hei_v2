...
export const PrivacyPolicyContent = () => {
  return (
    <div className={styles["privacy-policy"]}>
      <h1>Privacy Policy for Hrvatska esport inicijativa</h1>

      <p>
        At Hrvatska esport inicijativa, accessible from
        https://esportinicijativa.hr/, one of our main priorities is the privacy
        of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Hrvatska esport
        inicijativa and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Hrvatska esport inicijativa. This policy is not
      ...
      <p>
        Like any other website, Hrvatska esport inicijativa uses 'cookies'.
      ...
      <p>
        ...
        advertising partners of Hrvatska esport inicijativa.
      </p>
      ...
      <p>
        Note that Hrvatska esport inicijativa has no access to or control over
      ...
      <p>
        Hrvatska esport inicijativa's Privacy Policy does not apply to other
      ...
      <p>
        Hrvatska esport inicijativa does not knowingly collect any Personal
